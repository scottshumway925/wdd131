...
function validateForm(event) {
  ...
  if (theForm.paymentMethod.value === "creditCard") {
    if (theForm["credit-number"].value !== "1234123412341234") {
        isValid = false;
...
function togglePaymentDetails(e) {
  ...
  const creditInput = document.getElementById("credit-number")
  const paypalInput = document.getElementById("pp-username")
